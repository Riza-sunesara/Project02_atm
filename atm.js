...
async function F_transfer(balance) {
...
async function B_Pay(balance, account_num) {
    let user_input = await inquirer.prompt([
        {
...
async function C_Withdraw(balance) {
    let user_input = await inquirer.prompt([
        {
...
async function D_Funds(balance) {
    let user_input = await inquirer.prompt([
        {
